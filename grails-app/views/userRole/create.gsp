...
<html>
	...
	<body>
		...
		<div id="create-userRole" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:userRoleInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
