...
<html>
	...
	<body>
		...
		<div id="create-setMeal" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:setMealInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
