...
<html>
	...
	<body>
		...
		<div id="create-shiroUser" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:shiroUserInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
