...
<html>
	...
	<body>
		...
		<div id="create-shiroRole" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:shiroRoleInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
