...
<html>
	...
	<body>
		...
		<div id="create-calendar" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:calendarInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
