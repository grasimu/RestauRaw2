...
<html>
	...
	<body>
		...
		<div id="create-employee" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:employeeInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
