...
<html>
	...
	<body>
		...
		<div id="create-category" class="content scaffold-create form-group" role="main">
			...
			<g:form url="[resource:categoryInstance, action:'save']"  role="form" class="form-horizontal">
				<fieldset>
