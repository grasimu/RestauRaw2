...
<html>
	...
	<body>
		...
		<div id="edit-dish" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>

			<g:hasErrors bean="${dishInstance}">
			...
			<g:form url="[resource:dishInstance, action:'update']" method="PUT"  class="form-horizontal">
				<g:hiddenField name="version" value="${dishInstance?.version}" />
				<fieldset class="form">
